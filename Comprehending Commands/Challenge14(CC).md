...
### Solve
**Flag:** `pwn.college{syyoRkBDgFLqPEi-gckEOUeR0es.QX5ETN1wCM5AzNzEzW}`
I used the "ln -s" command to link the catflag and not-the-hacker files, then read out the catflag file to get the flag

### New Learnings
I learnt how to link the files as Symbolic Links
